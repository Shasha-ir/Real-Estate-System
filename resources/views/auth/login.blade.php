...
@section('content')
<div class="min-h-screen bg-fixed bg-cover bg-center flex flex-col items-center justify-center pt-24 pb-24 px-4" style="background-image: url('{{ asset('images/login.png') }}')">
    <div class="bg-white bg-opacity-50  shadow-xl rounded-xl p-8 w-full max-w-md">
        ...
        <div class="mt-8">
            ...
            <div class="flex justify-center gap-4">
                <button onclick="showPreviewModal('seller')" class="px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700 transition text-sm">
                    Seller Dashboard
                </button>
                <button onclick="showPreviewModal('buyer')" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition text-sm">
                    Buyer Dashboard
                </button>
            </div>
        </div>
    ...
    <div id="previewModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
            ...
            <div class="flex justify-end gap-4">
                ...
                <a id="proceedLink" href="#" class="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 text-sm">Proceed</a>
            </div>
        </div>
    </div>
</div>
