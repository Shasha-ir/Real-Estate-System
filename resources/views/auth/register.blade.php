        ...
        <div class="bg-white bg-opacity-50 shadow-2xl rounded-2xl w-full max-w-3xl p-10 animate-fade-in" data-aos="zoom-in">
            ...
            @if (session('success'))
                <div class="bg-green-100 text-green-800 px-4 py-3 rounded mb-6 text-sm" data-aos="fade-up">
                    {{ session('success') }}<br>
                    <strong>Your issued ID is:</strong>
                    <span class="font-mono text-indigo-700">{{ session('user_id') }}</span><br>
            ...
            @if ($errors->any())
                <div class="bg-red-100 text-red-800 px-4 py-3 rounded mb-6 text-sm">
                    <ul>
