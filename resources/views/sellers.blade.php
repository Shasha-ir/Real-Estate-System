...
<div class="min-h-screen bg-cover bg-center pt-24 pb-24 px-4" style="background-image: url('{{ asset('images/sellers.png') }}')">
    <div class="max-w-7xl mx-auto text-center bg-white bg-opacity-70 rounded-xl p-10 shadow-xl backdrop-blur-md">
        ...
        <p class="text-lg text-gray-700 mb-10" data-aos="fade-up" data-aos-delay="100">
            These professionals have consistently delivered quality service and exceptional results in property management and sales.
        </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            ...
            @foreach ($sellers as $index => $seller)
                <div class="bg-white bg-opacity-95 rounded-lg shadow-md overflow-hidden text-left transition-all duration-300" data-aos="zoom-in" data-aos-delay="{{ $index * 100 }}">
                    ...
                    <div class="p-4">
                        ...
                        <a href="#" class="inline-block bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 text-sm transition">View Listings</a>
                    </div>
                </div>
            @endforeach
        </div>
